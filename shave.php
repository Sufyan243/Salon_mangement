...
<!-- Mirrored from madebydesignesia.com/themes/blaxcut/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2024 10:43:35 GMT -->
<head>
    ...
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section aria-label="section" class="no-top no-bottom">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 offset-lg-3 text-center">
                            <img src="s.images/shave1.webp" class="img-fluid wow fadeInUp" alt="">
                        </div>
                        <div class="col-lg-8 offset-lg-2 text-center" data-jarallax-element="-20">
                            <h2 class="wow fadeInUp">Blaxcut Crafting <span class="id-color">Confidence</span>, One Cut at a Time</h2>
            ...
            <section class="jarallax">
                ...
                <div class="de-gradient-edge-bottom"></div>
                <img src="s.images/shave2.jpg" class="jarallax-img" alt="">
                <div class="container position-relative z1000">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 text-center">
                            <h2 class="wow fadeInUp">Hair <span class="id-color">Styles</span></h2>
                            <div class="spacer-single"></div>
                        </div>
                    </div>
                    <div id="gallery" class="row g-4 wow fadeInUp">

                        <div class="col-md-4 item">
                            <div class="de-image-hover rounded">
                                <a href="s.images/shave2.jpg" class="image-popup">                                
                                    <span class="dih-title-wrap">
                                        <span class="dih-title">Slickback</span>
                                    </span>
                                    <span class="dih-overlay"></span>
                                    <img src="s.images/shave2.jpg" class="lazy img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 item">
                            <div class="de-image-hover rounded">
                                <a href="images/hairstyles/2.jpg" class="image-popup">                                
                                    <span class="dih-title-wrap">
                                        <span class="dih-title">Classic Quiff</span>
                                    </span>
                                    <span class="dih-overlay"></span>
                        ...
                        <div class="col-md-4 item">
                            <div class="de-image-hover rounded">
                                <a href="images/hairstyles/3.jpg" class="image-popup">                                
                                    <span class="dih-title-wrap">
                                        <span class="dih-title">Pompadour</span>
                                    </span>
                                    <span class="dih-overlay"></span>
                        ...
                        <div class="col-md-4 item">
                            <div class="de-image-hover rounded">
                                <a href="images/hairstyles/4.jpg" class="image-popup">                                
                                    <span class="dih-title-wrap">
                                        <span class="dih-title">Fringe</span>
                                    </span>
                                    <span class="dih-overlay"></span>
                        ...
                        <div class="col-md-4 item">
                            <div class="de-image-hover rounded">
                                <a href="images/hairstyles/5.jpg" class="image-popup">                                
                                    <span class="dih-title-wrap">
                                        <span class="dih-title">Curly Fade</span>
                                    </span>
                                    <span class="dih-overlay"></span>
                        ...
                        <div class="col-md-4 item">
                            <div class="de-image-hover rounded">
                                <a href="images/hairstyles/6.jpg" class="image-popup">                                
                                    <span class="dih-title-wrap">
                                        <span class="dih-title">Undercut</span>
                                    </span>
                                    <span class="dih-overlay"></span>
                        ...
                        <div class="col-md-4 item">
                            <div class="de-image-hover rounded">
                                <a href="images/hairstyles/7.php" class="image-popup">                             
                                    <span class="dih-title-wrap">
                                        <span class="dih-title">Blaxcut Barbershop</span>
                                    </span>
                                    <span class="dih-overlay"></span>
                                    <img src="images/hairstyles/7.php" class="lazy img-fluid" alt="">
                                </a>
                            </div>
                        </div>                        
                    </div>
...
<!-- Mirrored from madebydesignesia.com/themes/blaxcut/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2024 10:43:36 GMT -->
</html>